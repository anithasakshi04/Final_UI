...
import React, { useState } from "react";
import { FaUserCircle, FaSignOutAlt, FaCog, FaBars } from "react-icons/fa";
import { Link, useNavigate, Outlet } from "react-router-dom";  // Added Outlet import
import "bootstrap/dist/css/bootstrap.min.css";
import Dropdown from "react-bootstrap/Dropdown";
import DropdownButton from "react-bootstrap/DropdownButton";
import SC_logo1 from "../assests/Images/SC_logo1.png";
...
export default function MainLayout() {
  ...
  return (
    <div className="d-flex flex-column vh-100 position-relative">
      <header
        className="d-flex align-items-center justify-content-between bg-primary bg-opacity-75 px-3 py-2"
        style={{ zIndex: 1051 }}
      >
        <div className="d-flex align-items-center">
          <img
      ...
      <div
        className="d-flex align-items-center w-100 px-4 py-2 bg-primary bg-opacity-50"
        style={{
          borderBottom: "1px solid #e9ecef",
          position: "relative",
          zIndex: 2,
      ...
      >
        ...
        <button className="btn btn-primary btn-sm me-3" onClick={() => navigate("/home")}>
          &lt; Back
        </button>
        <span className="fw-bold">Access Level : {user.accessLevel}</span>
        <span className="ms-auto fw-bold d-flex align-items-center color-white">
      ...
      <div
        className="flex-grow-1 d-flex position-relative"
        style={{
          minHeight: 0,
          backgroundColor: "#fff",
          backgroundSize: "26% auto",
      ...
      >
        ...
        {sidebarOpen && (
          <aside
            className="bg-primary bg-opacity-25 px-3 py-3 d-flex flex-column gap-4"
            style={{
              width: 200,
              minWidth: 120,
              zIndex: 1052,
          ...
          >
            <Link
              to="/home"
              className="btn btn-outline-success fw-bold w-200"
              style={{
                letterSpacing: "1px",
                textAlign: "center",
                color: "white",
        ...
        <main
          className="flex-grow-1 d-flex flex-column align-items-center pt-4"
          style={{ zIndex: 2 }}
        >
      ...
      <footer
        className="bg-primary py-2 text-white text-center"
        style={{ position: "fixed", bottom: 0, left: 0, width: "100%", zIndex: 1035, height: "35px" }}
      >
        <div>
